...
export const dictDataSeed: SeedDefinition = {
  ...
  async run() {
    const dataList = [
      ...
      // 系统开关
      { dictType: "sys_normal_disable", label: "正常", value: "1", sort: 1, status: 1, isDefault: 1 },
      { dictType: "sys_normal_disable", label: "停用", value: "0", sort: 2, status: 1, isDefault: 0 },
      // 系统是否
      ...
      // 通知状态
      { dictType: "sys_notice_status", label: "正常", value: "1", sort: 1, status: 1, isDefault: 1 },
      { dictType: "sys_notice_status", label: "关闭", value: "0", sort: 2, status: 1, isDefault: 0 },
    ];
