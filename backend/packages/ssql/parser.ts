...
export class Parser {
  ...
  private parsePrimary(): Expression | null {
    ...
    switch (t.type) {
      case TokenType.LParen: return this.parseGroup();
      case TokenType.Field: return this.parseField();
      case TokenType.EOF: return null;
      default: throw new Error(`意外的 token '${t.value}' 位置 ${t.pos}`);
    }
  }
  ...
  private strToOp(s: string): Op {
    switch (s) {
      ...
      case "<=": return Op.Lte;
      case "~": return Op.Like;
      case "!~": return Op.NotLike;
      case "?=": return Op.In;
      case "?!=": return Op.NotIn;
      case "?null": return Op.IsNull;
      case "?!null": return Op.NotNull;
      case "><": return Op.Between;
