...
export class Builder {
  ...
  eq(field: string, value?: Value): this {
    this.exprs.push(new FieldExpr(field, Op.Eq, value))
    return this
  }
  neq(field: string, value?: Value): this {
    this.exprs.push(new FieldExpr(field, Op.Neq, value))
    return this
  }
  gt(field: string, value?: Value): this {
    this.exprs.push(new FieldExpr(field, Op.Gt, value))
    return this
  }
  gte(field: string, value?: Value): this {
    this.exprs.push(new FieldExpr(field, Op.Gte, value))
    return this
  }
  lt(field: string, value?: Value): this {
    this.exprs.push(new FieldExpr(field, Op.Lt, value))
    return this
  }
  lte(field: string, value?: Value): this {
    this.exprs.push(new FieldExpr(field, Op.Lte, value))
    return this
  }

  // 模糊匹配
  like(field: string, value: string): this {
    this.exprs.push(new FieldExpr(field, Op.Like, value))
    return this
  }
  notLike(field: string, value: string): this {
    this.exprs.push(new FieldExpr(field, Op.NotLike, value))
    return this
  }

  // 集合操作
  in(field: string, values: Values): this {
    this.exprs.push(new FieldExpr(field, Op.In, values))
    return this
  }
  notIn(field: string, values: Values): this {
    this.exprs.push(new FieldExpr(field, Op.NotIn, values))
    return this
  }

  // 空值检查
  isNull(field: string): this {
    this.exprs.push(new FieldExpr(field, Op.IsNull))
    return this
  }
  notNull(field: string): this {
    this.exprs.push(new FieldExpr(field, Op.NotNull))
    return this
  }
