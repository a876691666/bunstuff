...
export class Lexer {
  ...
  private nextToken(): Token {
    ...
    // 单字符 token
    switch (c) {
      case "(": this.pos++; return { type: TokenType.LParen, value: "(", pos: p };
      case ")": this.pos++; return { type: TokenType.RParen, value: ")", pos: p };
      case "[": this.pos++; return { type: TokenType.LBracket, value: "[", pos: p };
      case "]": this.pos++; return { type: TokenType.RBracket, value: "]", pos: p };
      case ",": this.pos++; return { type: TokenType.Comma, value: ",", pos: p };
    }
